 ...
 * @since 1.6
 */
public abstract class AbstractScriptEngine  implements ScriptEngine { //抽象脚本 引擎
    ...
    public Object eval(Reader reader, Bindings bindings ) throws ScriptException {
        ...
        ScriptContext ctxt = getScriptContext(bindings); //获取脚本上下文

        return eval(reader, ctxt); //执行指定脚本
    }
