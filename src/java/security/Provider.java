...
public abstract class Provider extends Properties {
    ...
    // used as key in the serviceMap and legacyMap（旧版Map） HashMaps
    private static class ServiceKey { //服务key
    ...
    /**
     * The description of a security service. It encapsulates（封装） the properties
    ...
    public static class Service {
        ...
        public Object newInstance(Object constructorParameter)
                throws NoSuchAlgorithmException { //返回实现Service实例
            if (registered == false) {
