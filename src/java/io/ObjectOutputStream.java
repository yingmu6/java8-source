 ...
 * to an OutputStream.  The objects can be read (reconstituted 重新组成) using an
 * ObjectInputStream.  Persistent storage of objects can be accomplished（实现） by
 ...
 * appropriate（合适的） methods from DataOutput. Strings can also be written using the
 * writeUTF method.
 *
