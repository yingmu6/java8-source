...
/**
 * A multiplexor（多路复用器） of {@link SelectableChannel} objects.
 *
...
public abstract class Selector implements Closeable {
    ...
    /**
     * Selects a set of keys whose corresponding（相应的） channels are ready for I/O
     * operations.
     *
     * <p> This method performs a blocking <a href="#selop">selection
     * operation</a>.  It returns only after at least one channel is selected,
     ...
     *          If this selector is closed
     */
    public abstract int select() throws IOException; //返回与Channel关联的key数量（方法时阻塞的）
