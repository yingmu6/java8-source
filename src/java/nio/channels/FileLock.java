...
/**
 * A token representing a lock on a region of a file.(表示文件区域锁定的令牌。)
 *
 ...
 *
 * <p> A file-lock object is initially（最初） valid.  It remains valid until the lock
 ...
 *
 * <p> A file lock is either <i>exclusive</i> or <i>shared</i>.（文件锁是独占的或共享的 ）  A shared lock
