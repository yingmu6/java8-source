...
/**
 * A selectable channel for datagram-oriented sockets. （面向数据报套接字的可选通道）
 *
 * <p> A datagram channel is created by invoking one of the {@link #open open} methods
 * of this class. It is not possible to create a channel for an arbitrary（随意的）,
    ...
    implements ByteChannel, ScatteringByteChannel, GatheringByteChannel, MulticastChannel
{
     ...
     */
    public static DatagramChannel open() throws IOException { //打开数据包通道
