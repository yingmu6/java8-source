 ...
 * transformations</i>, such as serialization or deep-copying.（典型的应用场景：序列化和深度拷贝）
 * To perform such a transformation, a program must maintain a "node table" that keeps track
 ...
 *
 * <p>This class provides all of the optional map operations, and permits（提供了Map的所有操作，允许key和value都为null）
