...
public class Collections {
    ...
    /**
     * Sorts the specified list into ascending order（升序排序）, according to the
     * {@linkplain Comparable natural ordering} of its elements.
     * All elements in the list must implement the {@link Comparable}
     * interface（Collections中的所有的元素都需要实现Comparable接口）.  Furthermore（此外）, all elements in the list must be
    ...
    public static <T extends Comparable<? super T>> void sort(List<T> list) {//若没指定Comparator，则按升序排序
        list.sort(null);
    }
...
/**
        ...
        implements Set<E>, Serializable
    {
        ...
        SetFromMap(Map<E, Boolean> map) { //将Map转换为Set元素
            if (!map.isEmpty())
