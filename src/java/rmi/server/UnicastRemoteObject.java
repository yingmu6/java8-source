 ...
 * that communicates（沟通） to the remote object. Stubs are either generated
 * at runtime using dynamic proxy objects（动态代理对象）, or they are generated statically
 * at build time, typically（通常） using the {@code rmic} tool.
 *
 ...
 * @since   JDK1.1
 **/
public class UnicastRemoteObject extends RemoteServer { //Unicast: 单播
